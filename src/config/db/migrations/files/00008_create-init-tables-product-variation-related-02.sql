...
CREATE TABLE IF NOT EXISTS public.product_variant (
    ...
    mobile_variant_id bigint,
    laptop_variant_id bigint,
    fashion_variant_id bigint,
    air_conditioner_variant_id bigint,
    television_variant_id bigint,
    refrigerator_variant_id bigint,
    juice_variant_id bigint,
    book_variant_id bigint,
